(() => {
  ...
  function ensureElement() {
    ...
    el.innerHTML = `
      ...
      <div class="search-progress-detail"><span class="search-progress-eta">This may take a few moments...</span><button type="button" class="search-progress-cancel">Cancel</button></div>
    `;
